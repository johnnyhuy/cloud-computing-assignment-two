...
CREATE TABLE IF NOT EXISTS crime_data.councils
(
...
CREATE TABLE IF NOT EXISTS crime_data.suburbs
(
    name         VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS crime_data.offence_division
(
...
CREATE TABLE IF NOT EXISTS crime_data.offence_subdivision
(
...
CREATE TABLE IF NOT EXISTS crime_data.offence_subgroup
(
    offence_division_code    VARCHAR(1)   NOT NULL,
...
CREATE TABLE IF NOT EXISTS crime_data.crimes_vic
(
...
CREATE TABLE IF NOT EXISTS crime_data.crimes_vic_by_council
(
    year_ending                    INT           NOT NULL,
